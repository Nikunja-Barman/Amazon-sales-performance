# Amazon Sales Performance: A Data-Driven Analysis 🕵👨‍💻
...
### 3.	Sales by Market (Donut Chart & Map):
...
### 4.	Profit by Customer Name (Column Chart):
...
### 5.	Top 5 Loss by Product (Bar Chart):
...
### 6.	Top 5 Profit by Product (Bar Chart):
...
### 7.	Year Wise Sales (Timeline Slicer): 
